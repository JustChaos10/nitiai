    ...
    async def analyze_opportunity(
        ...
        try:
            ...
            session.agent_state = {
                ...
                "campaigns": [],  # Placeholder for campaign recommendations
            }
    ...
    def _calculate_confidence(self, state: ReasoningState) -> float:
        ...
        if validated_hypotheses:
            ...
            for h in validated_hypotheses:
                consensus = getattr(h, "consensus", {}) or {}
                confidence_value = consensus.get("confidence", 0.5)
                confidences.append(coerce_to_float(confidence_value, 0.5))
